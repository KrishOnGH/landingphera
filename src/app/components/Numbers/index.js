  ...
  return (
		<div>
			<section className="section-blue-purple text-[#8C8C8C] body-font">
				<div className="bg-[#27335F]/[0.2] min-h-dvh pb-32 lg:pb-40 flex flex-col pt-20 md:pt-40 lg:pt-1">
						...
						<div className="md:text-center w-full">
							<div className="justify-center flex ">
								<p className="leading-relaxed mb-8 lg:w-3/5 text-sm md:text-center text-[#817EB5]">
									...
									tested it against other popular chatbots. Below
									is the memory retention capabilities of various
									AI chatbots, measured by the number of queries
									it takes for them to forget information.
								</p>
							</div>
						</div>
					</div>
